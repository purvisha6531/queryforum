...
<div class="row">
    ...
    <table border="1" class="table table-bordered table-responsive">  
      <tbody> 
	 <tr>
		 <th class="black align">Project</th>
		 <th class="black align">Module</th>
       <th class="black align">Question</th>
        <th class="black align">Answer</th>
        <th class="black align">Img Url</th>
        <th class="black align">Date Of Answer</th>
         </tr>
          <?php  
         ...
         {  
            ...
            <td><?php echo $row->dateofanswer;?></td>
            </tr>
