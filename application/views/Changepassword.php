...
<!-- InstanceEndEditable -->
    ...
    <?php echo    form_open_multipart("C_Changepassword/password"); ?>
    <div class="container">
       <center> <h1 class="projecttitle">Change Password</h1></center>
   			 <div class="col-xs-offset-2 col-lg-8 project">
             
    <div class="row projectrow">
                	<center><div class="col-lg-3"><label>Current Password</label></div></center>
                    <div class="col-lg-6">
                    <input type="text" name="cpass" placeholder="CurrentPassword" class="form-control"/>
                  ...
                  <div class="row projectrow">
                	<center><div class="col-lg-3"><label>New Password</label></div></center>
                    <div class="col-lg-6">
                    <input type="text" name="npass" placeholder="NewPassword" class="form-control"/></div>
                </div>
                
                  <div class="row projectrow">
                	<center><div class="col-lg-3"><label>Re-enter Password</label></div></center>
                    <div class="col-lg-6">
                    <input type="text" name="rpass" placeholder="Re-Enter Password" class="form-control"/></div>
                </div>
