...
<!-- InstanceEndEditable -->
    ...
    <table border="1" class="table table-bordered table-condensed">  
      <tbody> 
         ...
         <tr>  
           <h2><td class="black align">Project Title</td></h2>
           
           <!--<h2> <td class="black align">Project Status Name</td></h2>
		   
		   <h2> <td class="black align">Module Name</td></h2>
		   
		   <h2> <td class="black align">Employee Name</td></h2>--->
         ...
         foreach ($d->result() as $row)  
         {
          ...
          <!--  <td><?php //echo $row->ProjectStatusName;?></td>
            ...
            <td><?php //echo $row->EmployeeName;?></td>--->
					...
					<td>
				<?php
				echo	"<a href=C_Projectstatusmore?id=".$row->ProjectId." class=btn>View More Detail</a></td>";
				?>
