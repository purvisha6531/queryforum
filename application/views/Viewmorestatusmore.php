...
<!-- InstanceEndEditable -->
    ...
    <table border="1" class="table table-bordered table-responsive">  
      <tbody> 
         ...
         {  
            ?><tr>  
           <td class="black align">Project Title</td> <td><?php echo $row->ProjectTitle;?></td></tr>
		   <tr><td class="black align">Project Detail</td><td><?php echo $row->ProjectDetail;?></td></tr>
   			<tr><td class="black align">Language Name</td><td><?php echo $row->LanguageName;?></td></tr>
			<tr><td class="black align">Logo URL</td><td><?php echo $row->LogoURL;?></td></tr>
			<tr><td class="black align">Start Date</td><td><?php echo $row->StartDate;?></td></tr>
			<tr><td class="black align">End Date</td><td><?php echo $row->EndDate;?></td></tr>
			<tr><td class="black align">Request Date</td><td><?php echo $row->RequestDate;?></td></tr>
    ...
    <table border="1" class="table table-bordered table-responsive">  
      <tbody> 
         ...
         {  
            ?><tr>  
           <td class="black align">ModuleName</td> <td><?php echo $row->ModuleName;?></td></tr>
		   <tr><td class="black align">Module Detail</td><td><?php echo $row->Detail;?></td></tr>
		   <tr><td class="black align">Flow Image URL</td><td><?php echo $row->FlowImgURL;?></td></tr>
		   <tr><td class="black align">Upload URL</td><td><?php echo $row->UploadURL;?></td></tr>
    ...
    <table border="1" class="table table-bordered table-responsive">  
      <tbody> 
         ...
         {  
           ...
           <td class="black align">Employee Name</td> <td><?php echo $row->EmployeeName;?></td></tr>
           <td class="black align">ModuleName</td> <td><?php echo $row->ModuleName;?></td></tr>
