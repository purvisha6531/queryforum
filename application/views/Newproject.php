...
<!-- InstanceEndEditable -->
   ...
   <?php echo    form_open_multipart("C_Newproject/project"); ?>
    	<div class="container">
       <center> <h1 class="projecttitle"> New Project Details</h1></center>
   			 <div class="col-xs-offset-2 col-lg-8 project">
             
             
    			<div class="row projectrow">
                	<center><div class="col-lg-3"><label>ProjectId</label></div></center>
                    <div class="col-lg-6">
                    <input type="text" name="projectid" placeholder="ProjectId" class="form-control" value="  <?php
								echo isset($qry1)?$qry1:0;?> " readonly="readonly"/>
                ...
                <div class="row projectrow">
                	<center><div class="col-lg-3"><label>Project Title</label></div></center>
                    <div class="col-lg-6">
                    <input type="text" name="projecttitle" placeholder="Project Title" class="form-control"/></div>
                </div>
                <div class="row projectrow">
                	<center><div class="col-lg-3"><label>Logo URL</label></div></center>
                    <div class="col-lg-6">
                   

<!--<input type="file" name="logourl"  />--->
<input type="text" name="logourl" placeholder="Logo Url" class="form-control"/></div>

    </div>
              <div class="row projectrow">
                	<center><div class="col-lg-3"><label>Client Name</label></div></center>
                    <div class="col-lg-6">
                    ...
                    <?php //echo $this->session->userdata('username'); ?> 
                      <?php
					            ...
					            ?>
        <input type="hidden" name="clientid" placeholder="Client ID" class="form-control" value="<?php  echo $row->ClientId; ?>"/>
        <input type="text" name="clientname"  class="form-control" value="<?php echo $row->Name; ?>"/>
                              <?php endforeach; }?> 
                    
                    </div>
                </div>
                <div class="row projectrow">
                	<center><div class="col-lg-3"><label>Select Language</label></div></center>
                    <div class="col-lg-6">
                      <select name="languageid" class="form-control" >
								...
								if(isset($qry))
								{
                                   ...
                                   <?php echo '<option value='.$row->LanguageId.'>'.$row->LanguageName.'</option>'; ?>
                 ...
                 <div class="row projectrow">
                	<center><div class="col-lg-3"><label>Project Detail</label></div></center>
                    <div class="col-lg-6">
                ...
                <div class="row projectrow">
                	<center><div class="col-lg-3"><label>Request Date</label></div></center>
                    <div class="col-lg-6">
                    <input type="text" name="requestdate" placeholder="Request Date" class="form-control"/></div>
                </div>
                
                 <div class="row projectrow">
                	<div class="col-lg-3"></div>
                    <div class="col-lg-6">
                    <input type="submit" name="submit" value="SUBMIT" class="form-control"/></div>
