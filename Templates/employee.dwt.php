                          ...
                          <!---  <div class="user-panel">
                           ...
                           <!-- <form action="#" method="get" class="sidebar-form">
                            ...
                            <ul class="sidebar-menu">
                                <li class="active">
                                    <a href="../web/employee.php">
                                        <i class="fa fa-dashboard"></i> <span>Home</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="../web/employee/manageproject.php">
                                        <i class="fa fa-gavel"></i> <span>Manage Project</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="../web/employee/clientdetail.php">
                                        <i class="fa fa-globe"></i> <span>Client Detail</span>
                                    </a>
                                </li>

								 <li>
                                    <a href="../web/employee/projectstatusdetail.php">
                                        <i class="fa fa-globe"></i> <span>Project Status Detail</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="../web/employee/forum.php">
