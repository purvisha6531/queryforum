...
$('#popup #close').on('click', function(evt) {
  evt.preventDefault();
// var id =$("#slct").children("option").filter(":selected").text??;
// var id  = $('#slct :selected').val();
...
<?php
	...
	$msg="";
	$ModuleId=$ModuleName=$ProjectId=$Detail=$FlowImgURL=$UploadURL=$Module="";
	$qry= mysql_query("select max(ModuleId)+1 from modulemaster");
							   $moduleid=mysql_fetch_row($qry);
							   $ModuleId=$moduleid[0];
	...
	if(isset($_POST['addmodule']))
	{
	   ...
	   $detail=$_POST['detail'];
	   $flow=$_POST['image'];
	   $detailupload=$_POST['detailupload'];
	   
	
	$path="moduleimage/";
		
    if($_FILES["image"]["type"] == "image/jpg"  || $_FILES["image"]["type"] == "image/jpeg" || $_FILES["image"]["type"] == "image/bmp" || $_FILES["image"]["type"] == "image/png")
     {
    ...
    else
{
 echo "InValid File Type";
	   ...
	   $qry= mysql_query("insert into  modulemaster values($moduleid,'$modulename','$projectid','$detail','$flow','$detailupload');");
  ...
  <section class="content">
			...
			<div class="row bgwhite margin">
					<ul class="breadcrumb">
                                ...
                                <li><a href="mainprojectpage.php">Project Detail</a></li>
								<li class="logofont active">Module Master</li>
              </ul>

					<center><h3 class="logofont"> Module Master</h3></center>
...
<div class="col-xs-offset-2 col-lg-8">
				 ...
				 <form method="post" action="" enctype="multipart/form-data">
					 <div class="form-group">
                           ...
                           <div class="col-lg-4">
                            ...
                            <div class="col-lg-5">  
					<select name="select" class="form-control"  id="slct">
	...
	<div class="col-xs-offset-3 col-lg-6">	
		...
		<div class="form-group">
                                   ...
                                   <div class="row">
                          		 <div class="col-lg-4">
                          		 <label class="black">Module Id</label>
                         		  </div>
                                   <div class="col-lg-5"> 
								   <input type="text" name="moduleid"  class="form-control" value="<?php if(isset($ModuleId)) { echo $ModuleId; }?>"/> 
								   </div>
                                   </div>
          </div>
		...
		<div class="form-group">		
                                   ...
                                   <div class="row">
                          		 <div class="col-lg-4">
                          		 <label class="black">Module Name</label>
                         		  </div>
                                   <div class="col-lg-5"> <input type="text" name="modulename"  class="form-control" value="<?php if(isset($ModuleName)) { echo $ModuleName; }?>" />
								    </div>
                                   </div>
          </div>
		...
		<div class="form-group">
                                   ...
                                   <div class="row">
                          		 <div class="col-lg-4">
                          		 <label class="black">Detail</label>
                         		  </div>
                                   <div class="col-lg-6"> <textarea name="detail" value="<?php if(isset($Detail)) { echo $Detail; }?>"> </textarea></div>
                                   </div>
          </div>
		...
		<div class="form-group">
                                   ...
                                   <div class="row">
                          		 <div class="col-lg-4">
                          		 <label class="black">File/Image Upload</label>
                         		  </div>
                                   <div class="col-lg-5"> <input type="file" name="image" class="form-control" value="<?php if(isset($FlowImgURL)) { echo $FlowImgURL;}?>"/>
		...
		<div class="form-group">
                                   ...
                                   <div class="row">
                          		 <div class="col-lg-4">
                          		 <label class="black">Detail Upload</label>
                         		  </div>
                                   <div class="col-lg-5"> <input type="text" name="detailupload" class="form-control" value="<?php if(isset($UploadURL)) { echo $UploadURL; }?>" /></div>
                                   </div>
          </div>
		  	...
		  	<div class="form-group">
                                   ...
                                   <div class="col-lg-4">  </div>
                                   <div class="col-lg-5"> 
								     <input type="submit" class="btn btn-primary" name="addmodule" value="ADD MODULE" /></div>
                                   </div>
          </div>
		</div>
	</div>
