...
<!-- InstanceBeginEditable name="body" -->
	...
	<div class="row bgwhite margin">
			...
			<ul class="breadcrumb">
								...
								<li><a href="newproject.php">New Project Detail</a></li>
								<li class="logofont active">Rejected Project Detail</h4></li>
      </ul>
		
		<center><h3 class="logofont">Rejected Project Detail</h3></center>
...
<?php
	 ...
	 $qry= mysql_query("select * from projectmaster where status='0'");
	 
	 echo "<center>";
	
	 
	  echo "<table>";
	  echo "<tr><th> Project Id </th><th> ProjectTitle </th><th>LogoURL</th><th> Client Id</th> <th>Language Id</th>
	  			<th> ProjectDetail</th> <th> Start Date </th><th>End Date</th><th>Request Date</th> <th>Status</th>
	  ...
	  if($qry)
	  {
		...
		$qry3=mysql_query("select Name from clientmaster where ClientId=$ClientId");
		 $rw3 = mysql_fetch_row($qry3);		
		  $qry4=mysql_query("select LanguageName from languagemaster where LanguageId=$LanguageId");
		 $rw4 = mysql_fetch_row($qry4);		
		 echo "<tr><td>$ProjectId</td><td>$ProjectTitle</td> <td>$LogoURL</td> <td> ".$rw3[0]."</td><td>".$rw4[0]."</td>
		 			<td>$ProjectDetail</td> <td>$StartDate</td> <td>$EndDate</td> <td>$RequestDate</td> <td>$Status</td>
