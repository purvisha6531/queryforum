...
<section class="content">
	...
	<div class="row bgwhite margin">
		...
		<ul class="breadcrumb">
                                <li><a href="mainprojectpage.php"><i class="fa fa-home"></i> Home</a></li>
                               
								<li class="logofont active">Forum Question</li>
      </ul>
		
		
		<center><h3 class="logofont">Forum Question</h3></center>
		...
		<div class="row bg1">	
		  ...
		  <div class="form-group">
                          		 ...
                          		 <label class="black">Select Module</label>
                                    ...
                                    <div class="col-lg-5">  
					<select name="selectmodule" class="form-control"  id="slct" onchange="this.form.submit()" >
		  ...
		  <div class="show">
					...
					<h2>Question</h2>
						...
						echo "<table>";
						 ...
						 {
							 echo "<tr><th> Question</th><th>Img Url</th><th>Date of Question</th><th>Answer</th><th>AnswerImg URL</th><th>Date Of Answer</th></tr>";
               $qry = mysql_query("select q.questionid,p.submitid,q.question,q.imgurl,q.dateofquestion,q.ViewedCount,m.ModuleId,p.employeeid,m.modulename,a.questionid,a.answer,a.imgurl,a.dateofanswer from queruforumquestion q inner join projectstatusdetail p on p.submitid=q.submitid inner join queruforumanswer a on a.questionid=q.questionid inner join modulemaster m on m.ModuleId=p.moduleid where m.moduleid='". $_POST['selectmodule'] ."'");
        while($rw = mysql_fetch_assoc($qry))             
             {
				 extract($rw);
				 
              echo "<tr><td>$question</td><td>$imgurl</td><td>$dateofquestion</td><td>$answer</td>
			  		<td>$imgurl</td><td>$dateofanswer</td></tr>";
			 }
