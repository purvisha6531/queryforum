...
<section class="content">
	...
	<div class="row bgwhite margin">
		...
		<ul class="breadcrumb">
								...
								<li class="logofont active">ProjectStatus Detail</li>
      </ul>
		
		
		<center><h3 class="logofont">Project Status Details</h3></center>
...
<?php
	...
	$qry=mysql_query("select ProjectId,ProjectTitle from projectmaster where Status='1'");
	 echo "<center>";
	  echo "<table>";
	  echo "<tr><th>Project Id</th><th> Project Name</th><th></th></tr>";
	  if($qry)
	  {
	     while($rw=mysql_fetch_assoc($qry))
		 {
		 ...
		 echo "<tr><td>$ProjectId</td><td>$ProjectTitle</td> <td> <a href='projectstatusdetailmore.php?id=$ProjectId'> View More </a></td></tr>";
