...
<?php
	...
	$msg="";
	$ProjectId=$ProjectTitle=$LogoURL=$ClientId=$LanguageId=$ProjectDetail=$StartDate=$EndDate=$RequestDate="";
	
	if(isset($_GET["projectid"]) && $_GET['flg']=="Delete")
	{
	    $qry = mysql_query("delete from projectmaster where projectid=".$_GET['projectid']."");
	   if(!$qry)
	   {
	   $msg = mysql_error();
	   }
	  ...
	  <section class="content">
			...
			<div class="row bgwhite margin">
					<ul class="breadcrumb">
								...
								<li class="logofont active">New Project Detail</li>
              </ul>

					<center><h3 class="logofont"> New Project Detail</h3></center>
	...
	<div class="col-xs-offset-2 col-lg-8">
		<div class="row bg">
			...
			<div class="form-group">
								   ...
								   <div class="row">
                                   	<div class="col-md-3"><a href="newprojectapprove.php"><h2 class="txtgreen">Approved</h2></a></div>
                                    <div class="col-md-2"></div>
                                    <div class="col-md-3"><a href="newprojectrejected.php"><h2 class="txtblue">Rejected</h2></a></div>
                                    <div class="col-md-2"></div>
                                    <div class="col-md-3"><a href="newprojectpending.php"><h2 class="txtred">Pending</h2></a></div>
                                    <div class="col-md-2"></div>
          </div>
	  </div>
  </div>				  
								<div class="show">  
								  ...
								  <?php
     //$qry = mysql_query("select ProjectId,ProjectName,LogoURL,ClientId,LanguageId,ProjectDetail,StartDate,EndDate,RequestDate from projectmaster");
	 
	 
	// $qry= mysql_query("select * from projectmaster");
	 ...
	 echo "<center>";
	  ...
	  echo "<table>";
	  echo "<tr><th> Project Id </th><th> ProjectTitle </th><th> Client Id</th> <th>Language Id</th> 
	  			
	 			 <th> Delete</th><th> More Details</th></tr>";
	  if($qry)
	  {
	     while($rw=mysql_fetch_assoc($qry))
		 {
		 extract($rw);
		 $qry3=mysql_query("select Name from clientmaster where ClientId=$ClientId");
		 $rw3 = mysql_fetch_row($qry3);		
		 echo "<tr><td>$ProjectId</td><td>$ProjectTitle</td><td>".$rw3[0]."</td><td>$LanguageId</td>
		 			
		 
		<td> <a href=?projectid=$ProjectId&flg=Delete>Delete </td>
		<td> <a href='newprojectmore.php?id=$ProjectId'> View More </a></td>
