...
<section class="content">
	...
	<div class="row bgwhite margin">
		<ul class="breadcrumb">
                                ...
                                <li class="logofont active">Project Detail</h4></li>
      </ul>
		
		<center><h3 class="logofont">Project Detail</h3></center>
			...
			<div class="row">
						...
						<div class="col-md-2">
                            <div class="stat">
                                ...
                                <h5 class="stat-info"><a href="newproject.php">New Project Detail</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#fa8564;">
                                    <i class="fa fa-users fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="modulemaster.php">Module Master</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#fa8564;">
                                    <i class="fa fa-users fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="projectassignment.php">Project Assignment</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#fa8564;">
                                    <i class="fa fa-users fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="projectstatusdetail.php">Project Status Detail</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#fa8564;">
                                    <i class="fa fa-users fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="forum.php">Forum Question</a></h5>
                            </div>
                        </div>
