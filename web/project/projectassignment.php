...
<?php
$msg="";
$ModuleId=$EmployeeId=$DateOfAssign=$EndDate=$Remark="";
	...
	if(isset($_POST['asign']))
	{
	   ...
	   $qry= mysql_query("insert into  projectassignment values('$module','$employee','$dateasign','$enddate','$remark');");
  ...
  <section class="content">
			...
			<div class="row bgwhite margin">
					<ul class="breadcrumb">
								...
								<li class="logofont active">Project Assignment</li>
              </ul>

					<center><h3 class="logofont">Project Assignment</h3></center>
        ...
        while($rw = mysql_fetch_row($qry))             
         ...
         ?>
		  ...
		  <div class="form-group">
                                   <div class="row">
                                   <div class="col-lg-4">
                          		 <label class="black">Date of Assign</label>
                         		  </div>
		  ...
		  <div class="form-group">
                                   <div class="row">
                                   <div class="col-lg-4">
                          		 <label class="black">End of Assign</label>
                         		  </div>
                                    <div class="col-lg-5"><input type="text" name="enddate" class="form-control"> </div>
                                   </div>
          </div>
		  ...
		  <div class="form-group">
                                   <div class="row">
                                   <div class="col-lg-4">
								   <label class="black">Remark</label>
                         		  </div>
                                    <div class="col-lg-5">
		  ...
		  <div class="form-group">
                                   ...
                                   <div class="col-lg-4">                         		  </div>
                                    <div class="col-lg-5">
									 <input type="submit" class="btn btn-primary" name="asign" value="Project Assign" /></div>
		    </div>
          </div>
      </div>
</div>
