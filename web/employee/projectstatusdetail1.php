...
<?php
     $qry = mysql_query("select c.employeeid,e.employeeid,c.msg,e.username from chatdetail c inner join employeemaster e on c.employeeid=e.employeeid where e.username='".$_SESSION['Uname']."' "");
