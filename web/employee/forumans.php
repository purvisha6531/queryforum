 ...
 if(isset($_POST['ansBtn']))
{
	...
	$qry=mysql_query("insert into queruforumanswer values('',".$_GET['id'].",'$text','','','','','')");
	}
...
?>
						...
						<div class="container">
							...
							<div class="col-xs-offset-2 col-lg-5">
								<h3>Forum Answer</h3>
  ...
  <div class="row">
    <div class="col-xs-offset-3 col-lg-7">
	  <b>Post Answer </b>
	  <textarea name="ans" class="form-control" rows="10"></textarea>
	</div>
  </div>
  <div class="row">
    <div class="col-xs-offset-3 col-lg-5">
	 <div style="float:right"> <br><input type="submit" name="ansBtn" value="Post Ans"> </div>
	</div>
  </div>
</form>
