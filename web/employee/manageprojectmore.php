...
<section class="content">
	...
	<div class="row bgwhite margin">
		...
		<ul class="breadcrumb">
								...
								<li class="logofont active">Project Detail</li>
      </ul>
...
<div class="col-xs-offset-1 col-lg-10">
	...
	<div class="col-lg-5 bg">
	<center><h4 class="logofont">Client Detail</h4></center>
	
	<?php
	 if(isset($_GET['id'])){
		// $qry=mysql_query("select * from projectmaster where ProjectId='2'");
		 
		 $qry=mysql_query("select p.projectid,p.projecttitle,c.clientid,c.name,c.address,c.pincode from projectmaster p inner join clientmaster c on p.clientid=c.clientid where p.projectid=".$_GET['id']."");
