...
$ProjectTitle=$ModuleId=$ProjectId="";
...
<!-- InstanceBeginEditable name="body" -->
	...
	<div class="row bgwhite margin">
		<ul class="breadcrumb">
								...
								<li class="logofont active">Manage Project</li>
      </ul>
		
		
		<center><h3 class="logofont">Manage Project</h3></center>
...
<?php
   ...
   //$qry = mysql_query("select ModuleId,ProjectId from modulemaster");
  
  $qry=mysql_query("select p.projectid,m.moduleid,p.projecttitle,m.modulename from projectmaster p inner join modulemaster m on m.projectid=p.projectid inner join projectassignment pa on m.moduleid=pa.moduleid where pa.employeeid=$employeeid");
   

	 echo "<center>";
	  echo "<table>";
	  echo "<tr><th> Project Name</th><th></th></tr>";
	  if($qry)
	  {
	     while($rw=mysql_fetch_assoc($qry))
		 {
		...
		// $qry2=mysql_query("select ProjectTitle from projectmaster where ProjectId=$ProjectId");	
		 ...
		 echo "<tr><td>$projecttitle</td> <td> <a href='manageprojectmore.php?id=$projectid'> View More </a></td></tr>";
