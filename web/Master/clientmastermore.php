...
<section class="content">
	...
	<div class="row bgwhite margin">
		...
		<ul class="breadcrumb">
								...
								<li class="logofont active">Client Master More Details</li>
      </ul>
		
		
		<center><h3 class="logofont">ClientMaster more Details</h3></center>
 ...
 <?php
								  if(isset($_GET['id'])){
    $qry1 =mysql_query("select * from clientmaster where ClientId=".$_GET['id']."");
	...
	// $//qry= mysql_query("select * from projectmaster");
	 ...
	 echo "<center>";
	  ...
	  if($qry1)
	  {
		 ...
		 $qry3=mysql_query("select StateName from statemaster where StateId=$StateId");
		 $rw3 = mysql_fetch_row($qry3);	
		  $qry4=mysql_query("select CountryName from countrymaster where CountryId=$CountryId");
		 $rw4 = mysql_fetch_row($qry4);		
		  ...
		  echo "<tr> </tr>
		      ...
		      <tr> <td> ClientId </td> <td>$ClientId</td> </tr>
			  <tr> <td> Name </td> <td>$Name</td> </tr>
			   <tr> <td> Address </td> <td>$Address</td> </tr>
			   <tr> <td> Pincode </td> <td>$Pincode</td> </tr>
			    <tr> <td> State Name</td> <td>".$rw3[0]."</td> </tr>
				 <tr> <td> Country Name </td> <td>".$rw4[0]."</td> </tr>
				  <tr> <td> EmailId </td> <td>$EmailId</td> </tr>
