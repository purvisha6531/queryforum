...
<?php
	...
	$ProjectStatusId=$ProjectStatusName="";
	 $qry= mysql_query("select max(ProjectStatusId)+1 from projectstatusmaster");
								   $projectstatusid=mysql_fetch_row($qry);
								   $ProjectStatusId=$projectstatusid[0];
	//insert code
	if(isset($_POST['insert']))
	{
	   $projectstatusid= $_POST['projectstatusid'];
	   $projectstatusname=$_POST['projectstatusname'];
	   $qry = mysql_query("insert into projectstatusmaster values($projectstatusid,' $projectstatusname');");
	   if(!$qry)
	   {
	   $msg = mysql_error();
	   }
 ...
 $qry= mysql_query("select max(ProjectStatusId)+1 from projectstatusmaster");
								   ...
								   $ProjectStatusId=$projectstatusid[0];
///edit btn code
	if(isset($_GET["projectstatusid"]) && $_GET['flg']=="Edit")
	{
	    $qry = mysql_query("select ProjectStatusId,ProjectStatusName from projectstatusmaster where projectstatusid=".$_GET['projectstatusid']."");
	...
	if(isset($_POST['update']))
	{
	 $projectstatusid= $_POST['projectstatusid'];
	   $projectstatusname=$_POST['projectstatusname'];
	   $qry =mysql_query("update projectstatusmaster set projectstatusname=' $projectstatusname' where projectstatusid= $projectstatusid");
	if(!$qry)
	   {
	   $msg = mysql_error();
	   }
	   ...
	   {
	   $msg = "Record Updated...";
	   header('location: projectstatusmaster.php');
	   }
	}
	//delete code
	if(isset($_GET["projectstatusid"]) && $_GET['flg']=="Delete")
	{
	    $qry = mysql_query("delete from projectstatusmaster where projectstatusid=".$_GET['projectstatusid']."");
	   if(!$qry)
	   {
	   $msg = mysql_error();
	   }
...
<!-- InstanceBeginEditable name="body" -->
	...
	<div class="row bgwhite margin">
			...
			<ul class="breadcrumb">
								...
								<li class="logofont active">project status Master</li>
      </ul>
		
		
		
		<center><h3 class="logofont">Project Status Master</h3></center>
	...
	<div class="col-xs-offset-2 col-lg-8">
		<div class="row bg">
			...
			<div class="form-group">
                           ...
                           <div class="row">
                           <div class="col-lg-4">
                          	 <label class="black">Enter Project StatusId</label>
                           </div>
                            <div class="col-lg-5">
     <input type="text" name="projectstatusid" class="form-control" value="<?php if(isset($ProjectStatusId)) { echo $ProjectStatusId; }?>" />
                            </div>
                            </div>
                            </div>
                                   <div class="form-group">
                           ...
                           <div class="row">
                           <div class="col-lg-4">
                          	 <label class="black">Enter Project Status Name</label>
                           </div>
                            <div class="col-lg-5">
  <input type="text" name="projectstatusname" class="form-control" value="<?php if(isset($ProjectStatusName)) { echo $ProjectStatusName; }?> "/>
                            </div>
                            </div>
                            </div>
                            		 <div class="form-group">
                             ...
                             <div class="row">
                              ...
                              <div  class="show">
<?php
     $qry = mysql_query("select ProjectStatusId,ProjectStatusName from projectstatusmaster");
	 echo "<center>";
	  echo "<table>";
	  echo "<tr><th> Project Status Id </th><th> Project Status Name </th><th></th></tr>";
	  if($qry)
	  {
	     while($rw=mysql_fetch_assoc($qry))
		 {
		 ...
		 echo "<tr><td>$ProjectStatusId</td><td>$ProjectStatusName</td>
		 <td>
		  <button class='btn btn-default btn-xs'>
		  <a href=?projectstatusid=$ProjectStatusId&flg=Edit><i class='fa fa-pencil'></a></i></button>
	
		  <button class='btn btn-default btn-xs'>
		<a href=?projectstatusid=$ProjectStatusId&flg=Delete><i class='fa fa-times'></a></i></button></td></tr>";
