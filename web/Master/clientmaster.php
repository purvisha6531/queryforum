...
<!-- InstanceBeginEditable name="head" -->
 ...
 <?php
	...
	$msg="";
	$ClientId=$Name=$Address=$Pincod=$StateId=$CountryId=$EmailId=$Status="";
	...
	if(isset($_GET["clientid"]) && $_GET['flg']=="Delete")
	{
	   ...
	   {
	   $msg = "Record Updated...";
	   header('location: clientmaster.php');
	   }
	}
...
<section class="content">
	...
	<ul class="breadcrumb">
								...
								<li class="logofont active">Client Master</h4></li>
      </ul>
		
		
		<center><h3 class="logofont">Client Master</h3></center>
...
<?php
	 ...
	 echo "<center>";
	  ...
	  echo "<table>";
	  echo "<tr><th> Client Id </th><th> Name </th><th>Email Id</th><th>Status</th>
	 			 <th></th><th></th></tr>";
	  ...
	  if($qry)
	  {
		 ...
		 {
		 extract($rw);
		 echo "<tr><td>$ClientId</td><td>$Name</td><td>$EmailId</td><td>$Status</td>
		 		
			<td> <a href='clientmastermore.php?id=$ClientId'> View More </a></td>
			<td>
			
		  <button class='btn btn-default btn-xs'>
			 <a href=?clientid=$ClientId&flg=Delete><i class='fa fa-times'></a></i></button></td></tr>";
			
		
		
			
	//	$citymaster = 'citymaster.php';
