...
<section class="content">
	...
	<div class="row bgwhite margin">
			...
			<ul class="breadcrumb">
								...
								<li class="logofont active">Master Table</h4></li>
      </ul>
		
		<center><h3 class="logofont">Master Table</h3></center>
...
<section class="content">
			<div class="row">
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#fa8564;">
                                    <i class="fa fa-users fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="usertypemaster.php">User Type Master</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#45cf95;">
                                    <i class=" fa fa-user fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="clientmaster.php">Client Master</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#AC75F0;">
                                    <i class=" fa fa-refresh fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="citymaster.php">City Master</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#45cf95;">
                                    <i class=" fa fa-arrow-circle-down fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="statemaster.php">State Master</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#fa8564;">
                                    <i class="fa fa-location-arrow  fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="countrymaster.php">Country Master</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#AC75F0;">
                                    <i class=" fa fa-laptop fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="languagemaster.php">Language Master</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#AC75F0;">
                                    <i class="fa fa-envelope   fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="designationmaster.php">Designation Master</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                <div class="stat-icon" style="color:#AC75F0;">
                                    <i class="fa fa-envelope   fa-3x stat-elem"></i>                                </div>
                                <h5 class="stat-info"><a href="projectstatusmaster.php">Project Status Master</a></h5>
                            </div>
                        </div>
