...
<?php
	...
	$CountryId=$CountryName="";
	 $qry= mysql_query("select max(CountryId)+1 from countrymaster");
								   $countryid=mysql_fetch_row($qry);
	...
	if(isset($_POST['insert']))
	{
	   ...
	   $qry = mysql_query("insert into countrymaster values($countryid,'$countryname');");
	   if(!$qry)
	   {
	   $msg = mysql_error();
	   }
 ...
 $qry= mysql_query("select max(CountryId)+1 from countrymaster");
								   ...
								   $CountryId=$countryid[0];
///edit btn code
	if(isset($_GET["countryid"]) && $_GET['flg']=="Edit")
	{
	    $qry = mysql_query("select CountryId,CountryName from countrymaster where countryid=".$_GET['countryid']."");
	...
	if(isset($_POST['update']))
	{
	 $countryid= $_POST['countryid'];
	   $countryname=$_POST['countryname'];
	   $qry =mysql_query("update countrymaster set countryname='$countryname' where countryid=$countryid");
	if(!$qry)
	   {
	   $msg = mysql_error();
	   }
	...
	//delete code
	if(isset($_GET["countryid"]) && $_GET['flg']=="Delete")
	{
	    $qry = mysql_query("delete from countrymaster where countryid=".$_GET['countryid']."");
	   if(!$qry)
	   {
	   $msg = mysql_error();
	   }
...
<!-- InstanceBeginEditable name="body" -->
	...
	<div class="row bgwhite margin">
			...
			<ul class="breadcrumb">
								...
								<li class="logofont active">Country Master</li>
      </ul>
		
		
		
		<center><h3 class="logofont">Country Master</h3></center>
	...
	<div class="col-xs-offset-2 col-lg-8">
		<div class="row bg">
			...
			<div class="form-group">
                           ...
                           <div class="row">
                           <div class="col-lg-4">
                          	 <label class="black">Enter CountryId</label>
                           </div>
                            <div class="col-lg-5">
     <input type="text" name="countryid" class="form-control" value="<?php if(isset($CountryId)) { echo $CountryId; }?>" />
                            </div>
                            </div>
                            </div>
                                   <div class="form-group">
                           ...
                           <div class="row">
                           <div class="col-lg-4">
                          	 <label class="black">Enter Country Name</label>
                           </div>
                            <div class="col-lg-5">
  <input type="text" name="countryname" class="form-control" value="<?php if(isset($CountryName)) { echo $CountryName; }?> "/>
                            </div>
                            </div>
                            </div>
                            		 <div class="form-group">
                             ...
                             <div class="row">
                              ...
                              <div  class="show">
<?php
     $qry = mysql_query("select CountryId,CountryName from countrymaster");
	 echo "<center>";
	  echo "<table>";
	  echo "<tr><th> Country Id </th><th> Country Name </th><th></th></tr>";
	  if($qry)
	  {
	     while($rw=mysql_fetch_assoc($qry))
		 {
		 ...
		 echo "<tr><td>$CountryId</td><td>$CountryName</td>
		 <td>
		  <button class='btn btn-default btn-xs'>
		  <a href=?countryid=$CountryId&flg=Edit><i class='fa fa-pencil'></a></i></button>
	
		  <button class='btn btn-default btn-xs'>
		<a href=?countryid=$CountryId&flg=Delete><i class='fa fa-times'></a></i></button></td></tr>";
