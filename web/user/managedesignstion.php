...
<?php
	 ...
	 if(isset($_GET["eid"]) && $_GET['flg']=="Delete")
	{
	    $qry = mysql_query("delete from employeedesignationdetail where employeeid=".$_GET['eid']." and designationid=".$_GET['did']."");
	    if(!$qry)
	   {
	   $msg = mysql_error();
	   }
	   ...
	   {
	   $msg = "Record Updated...";
	  header('location: managedesignstion.php');
					     ...
					     if(isset($_POST['Insert']))
					   {
						   ...
						   $eid=$_POST['eid'];
						   $qry = mysql_query("select * from designationmaster");
						   ...
						   {  
						       ...
						       {
								   $id = $_POST["chk$i"];
								    $qry1 = mysql_query("insert into employeedesignationdetail values('$eid',$id)");
...
<!-- InstanceBeginEditable name="body" -->
	...
	<div class="row bgwhite margin">
		...
		<center><h3 class="logofont">Manage Designation</h3></center>
		...
		<div class="row bg">
		  ...
		  <form method="post" action="">
                      <div class="form-group">
                                   <div class="row">
                                   <div class="col-lg-4">
                                   <label class="black">Select EmployeeName</label>
                                   </div>
                                   <div class="col-lg-5">
						   ...
						   for($i=1;$i<=mysql_num_rows($qry);$i++)
						   {
							   ...
							   $clmnid = $rw[0];
							   echo "<br><input type='checkbox' name=chk$clmnid value=$clmnid >".$rw[1];
    ...
    <div  class="show">
	                     <?php
					     $qry = mysql_query("select e.EmployeeId,e.employeename,d.designationname,d.designationid from employeedesignationdetail e1 INNER join employeemaster e on e.EmployeeId=e1.EmployeeId INNER JOIN designationmaster d on d.DesignationId=e1.DesignationId");
						 echo "<table class=table-responsive>";
 echo "<tr><th> EmployeeId</th><th> EmployeeName </th> <th> DesignationName </th><th></th></tr>";
						 while($ary = mysql_fetch_assoc($qry))
					 {
						 extract($ary);
						 echo "<tr><td> $EmployeeId</td><td> $employeename </td> <td>$designationname </td>
						  <td>
						  <button class='btn btn-default btn-xs'>
		<a href=?eid=$EmployeeId&did=$designationid&flg=Delete><i class='fa fa-times'></a></i></button></td> </tr>";
					 }
					 echo "</table>";
					 ?>   
  </div>  
