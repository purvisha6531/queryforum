...
<section class="content">
	...
	<div class="row bgwhite margin">
		...
		<center><h3 class="logofont">User Table</h3></center>
			...
			<div class="row">
						...
						<div class="col-md-2">
                            <div class="stat">
                                ...
                                <h5 class="stat-info"><a href="addclient.php">Add Client Detail</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                ...
                                <h5 class="stat-info"><a href="addemployee.php">Add Employee Detail</a></h5>
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="stat">
                                ...
                                <h5 class="stat-info"><a href="managedesignstion.php">Manage Degisnation</a></h5>
                            </div>
                        </div>
